...
numeric_years <- as.numeric(years[-length(years)])
...
years[years!='YEAR']
ordinal_years  <- factor(years[years!='YEAR'], order=TRUE)
ordinal_years
...
first_three_days_march <- as.Date(c('01/03/2019','02/03/2019','03/03/2019'), format='%d/%m/%Y') 
